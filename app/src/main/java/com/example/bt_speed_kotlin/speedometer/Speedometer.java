package com.example.bt_speed_kotlin.speedometer;
...
import com.example.bt_speed_kotlin.R;
...
public class Speedometer extends View implements SpeedChangeListener{
    ...
    private void initDrawingTools(){
        ...
        //scalePaint.setShadowLayer(5f, 0f, 0f, Color.GRAY);
        ...
        //offMarkPaint.setShadowLayer(3f, 0f, 0f, getResources().getColor(android.R.color.secondary_text_light));
        readingPaint.setTextSize(65f);
        readingPaint.setTypeface(Typeface.SANS_SERIF);
        readingPaint.setColor(Color.GRAY);
